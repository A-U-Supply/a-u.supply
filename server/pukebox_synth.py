...
Vendored from ausupply.github.io/midi-bot/src/synthesizer.py so the Puke Box
ingest pipeline can render OGG previews without depending on the midi-bot
repo. Sine-wave synthesis only — deliberately lo-fi, matching the aesthetic
of the original Puke Box.
"""
import logging
